# Project Agent Policy (Claude)

## Project-Specific Source Of Truth

- Read `/BOOTSTRAPPER_SPEC.md` before planning or implementing bootstrapper behavior.
- Use `/README.md` for repo onboarding, clone workflow, and GitHub setup notes.
- Treat `/projectbootstrapper.txt` as a legacy reference only, not the authoritative product spec.
